...
(expect 10 (count (get-entries    miles_davis_data b)))
...
;; Counting entries in standard test data
(expect 10 (count (get-entries    miles_davis_data_google g   )))
